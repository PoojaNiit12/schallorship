...
<div class="secttionform mt-5">
  ...
  <tr>
    ...
    <td class="colon">:</td>
    <td>
                            <div id="ctl00_ContentPlaceHolder1_DivCourse" style="font-weight: bold">B.Ed.</div>
                        </td>
  </tr>
  <tr>
    ...
    <td class="colon">:</td>
    <td>
                            <span id="Anthem_ctl00_ContentPlaceHolder1_txtName__"><input name="ctl00$ContentPlaceHolder1$txtName" type="text" value="RATNA SHARMA" maxlength="50" id="ctl00_ContentPlaceHolder1_txtName" class="textboxlong" style="text-transform: uppercase"></span><span style="color: red">*</span>
                        </td>
  </tr>
  <tr>
    ...
    <td>
                            ...
                            <span id="Anthem_ctl00_ContentPlaceHolder1_txtFatherName__"><input name="ctl00$ContentPlaceHolder1$txtFatherName" type="text" value="LEELA DHAR" maxlength="50" id="ctl00_ContentPlaceHolder1_txtFatherName" class="textboxlong" style="text-transform: uppercase"></span><span style="color: red">*</span>
  ...
  <tr>
    ...
    <td class="colon">:</td>
    <td>
                            <span id="Anthem_ctl00_ContentPlaceHolder1_txtMName__"><input name="ctl00$ContentPlaceHolder1$txtMName" type="text" value="RAKSHA DEVI" maxlength="50" id="ctl00_ContentPlaceHolder1_txtMName" class="textboxlong" style="text-transform: uppercase"></span><span style="color: red">*</span>
                        </td>
  </tr>
  ...
  <tr>
    ...
    <td class="colon">:</td>
    <td>
                            <span id="Anthem_ctl00_ContentPlaceHolder1_txtEmail__"><input name="ctl00$ContentPlaceHolder1$txtEmail" type="text" value="test@gmail.com" maxlength="50" id="ctl00_ContentPlaceHolder1_txtEmail" disabled="disabled" class="textboxlong" ondrop="return false;"></span><span style="color: red">*</span></td>
  </tr>
  <tr>
    ...
    <td>
                            <span id="Anthem_ctl00_ContentPlaceHolder1_txtDob__"><input type="date" id="date" name="date">
                                <img align="absMiddle" alt="" border="0" class="PopcalTrigger" height="20"></a>
  ...
  <tr>
    ...
    <td class="colon">:</td>
    <td>
                            <span id="Anthem_ctl00_ContentPlaceHolder1_txtAadhaarNo__"><input name="ctl00$ContentPlaceHolder1$txtAadhaarNo" type="text" value="416470942157" maxlength="12" id="ctl00_ContentPlaceHolder1_txtAadhaarNo" ondrop="return false;" ondrag="return false;" class="textboxlong" onkeypress="return isNumber(event)"></span>
                        </td>
  </tr>
  <tr>
    ...
    <td class="colon">:</td>
    <td>
                            <span id="Anthem_ctl00_ContentPlaceHolder1_txtHSchoolCno__"><input name="ctl00$ContentPlaceHolder1$txtHSchoolCno" type="text" value="1302143" maxlength="20" id="ctl00_ContentPlaceHolder1_txtHSchoolCno" class="textboxlong" ondrop="return false;" onpaste="return false;"></span><span style="color: red">*</span>
                        </td>
  </tr>
  <tr>
    ...
    <td>
      ...
      <tbody><tr>
        <td><span><input id="ctl00_ContentPlaceHolder1_rdNationality_0" type="radio" name="ctl00$ContentPlaceHolder1$rdNationality" value="I" checked="checked"><label for="ctl00_ContentPlaceHolder1_rdNationality_0">Indian</label></span></td><td><span><input id="ctl00_ContentPlaceHolder1_rdNationality_1" type="radio" name="ctl00$ContentPlaceHolder1$rdNationality" value="O"><label for="ctl00_ContentPlaceHolder1_rdNationality_1">Other</label></span></td>
      </tr>
    </tbody></table></div>
  ...
  <tr>
    ...
    <td>
      ...
      <tbody><tr>
        <td><span><input id="ctl00_ContentPlaceHolder1_rdSex_0" type="radio" name="ctl00$ContentPlaceHolder1$rdSex" value="M"><label for="ctl00_ContentPlaceHolder1_rdSex_0">Male</label></span></td><td><span><input id="ctl00_ContentPlaceHolder1_rdSex_1" type="radio" name="ctl00$ContentPlaceHolder1$rdSex" value="F" checked="checked"><label for="ctl00_ContentPlaceHolder1_rdSex_1">Female</label></span></td>
      </tr>
    </tbody></table></div>

                        </td>
  </tr>
  <tr id="ctl00_ContentPlaceHolder1_trBonafide">
    <td class="vtext"><span id="ctl00_ContentPlaceHolder1_spnBonafide1">Are you a Bonafide Residentof Himachal Pradesh ?</span>
                            <br>
                            <strong id="ctl00_ContentPlaceHolder1_spnBonafide2">क्या आप हिमाचल प्रदेश के बोनाफाइड रेजिडेंट हैं</strong></td>
    <td class="colon">:</td>
    <td>
                            <div style="width: 30%">
                                <div id="Anthem_ctl00_ContentPlaceHolder1_rdBonafide__"><table id="ctl00_ContentPlaceHolder1_rdBonafide" class="radio" onclick="return confirmHPBonafideSelection();" border="0">
      <tbody><tr>
        <td><span><input id="ctl00_ContentPlaceHolder1_rdBonafide_0" type="radio" name="ctl00$ContentPlaceHolder1$rdBonafide" value="Y" checked="checked"><label for="ctl00_ContentPlaceHolder1_rdBonafide_0">Yes</label></span></td><td><span><input id="ctl00_ContentPlaceHolder1_rdBonafide_1" type="radio" name="ctl00$ContentPlaceHolder1$rdBonafide" value="N" onclick="javascript:Anthem_FireCallBackEvent(this,event,'ctl00$ContentPlaceHolder1$rdBonafide','1',false,'','','',true,null,null,null,true,true);"><label for="ctl00_ContentPlaceHolder1_rdBonafide_1">No</label></span></td>
      </tr>
    </tbody></table></div>
                                <span style="color: red; float: right; margin-top: -20%">*</span>
                            </div>
                        </td>
  </tr>
  <tr id="ctl00_ContentPlaceHolder1_trChildofHPBonafideNO">
    <td colspan="3">
                            <div id="Anthem_ctl00_ContentPlaceHolder1_pnlChildofHPBonafideNO__"></div>
                        </td>
  </tr>
  <tr id="ctl00_ContentPlaceHolder1_trChildofHPBonafideSubNO">
    <td colspan="3">
                            <div id="Anthem_ctl00_ContentPlaceHolder1_pnlChildofHPBonafideSubNO__"></div>
                        </td>
  </tr>
  <tr id="ctl00_ContentPlaceHolder1_trtrChildofHPBonafideYES">
    <td colspan="3">
                            <div id="Anthem_ctl00_ContentPlaceHolder1_pnltrChildofHPBonafideYES__"></div>
                        </td>
  </tr>
  <tr id="ctl00_ContentPlaceHolder1_trtrtrChildofHPBonafideSubYES">
    <td colspan="3">
                            <div id="Anthem_ctl00_ContentPlaceHolder1_pnltrtrChildofHPBonafideSubYES__"></div>
                        </td>
  </tr>
  <tr id="ctl00_ContentPlaceHolder1_trSingleGirlChild">
    ...
    <td>
      ...
      <tbody><tr>
        <td><span><input id="ctl00_ContentPlaceHolder1_rdbsinglegirlchild_0" type="radio" name="ctl00$ContentPlaceHolder1$rdbsinglegirlchild" value="Y"><label for="ctl00_ContentPlaceHolder1_rdbsinglegirlchild_0">Yes</label></span></td><td><span><input id="ctl00_ContentPlaceHolder1_rdbsinglegirlchild_1" type="radio" name="ctl00$ContentPlaceHolder1$rdbsinglegirlchild" value="N" checked="checked"><label for="ctl00_ContentPlaceHolder1_rdbsinglegirlchild_1">No</label></span></td>
      </tr>
    </tbody></table></div>
  ...
  <tr id="ctl00_ContentPlaceHolder1_trJandKDomocile">
    <td class="vtext">
                            <div>
                                Do you belongs to J&amp;K State?<br>
                                <strong>क्या आप जम्मू और कश्मीर राज्य से हैं?</strong>
                            </div>
    ...
    <td>
                            <div style="width: 18%">
                                <div id="Anthem_ctl00_ContentPlaceHolder1_rdbJandkDomocile__"><table id="ctl00_ContentPlaceHolder1_rdbJandkDomocile" class="radio" border="0">
      <tbody><tr>
        <td><span><input id="ctl00_ContentPlaceHolder1_rdbJandkDomocile_0" type="radio" name="ctl00$ContentPlaceHolder1$rdbJandkDomocile" value="Y"><label for="ctl00_ContentPlaceHolder1_rdbJandkDomocile_0">Yes</label></span></td><td><span><input id="ctl00_ContentPlaceHolder1_rdbJandkDomocile_1" type="radio" name="ctl00$ContentPlaceHolder1$rdbJandkDomocile" value="N" checked="checked"><label for="ctl00_ContentPlaceHolder1_rdbJandkDomocile_1">No</label></span></td>
      </tr>
    </tbody></table></div>
  ...
  <tr id="ctl00_ContentPlaceHolder1_trStream">
    <td class="vtext"><span id="ctl00_ContentPlaceHolder1_Span_Streamengg">Stream (As per norms)</span><br>

                            <strong><span id="ctl00_ContentPlaceHolder1_Span_Streamhindi">स्ट्रीम (मानदंड के अनुसार)</span></strong></td>
    <td class="colon">:</td>
    <td>

                            <span id="Anthem_ctl00_ContentPlaceHolder1_ddl_Stream__"><select name="ctl00$ContentPlaceHolder1$ddl_Stream" id="ctl00_ContentPlaceHolder1_ddl_Stream" class="dropdownlong" onchange="StreamOnchange(this)">
      <option value="0">-- Select Stream --</option>
      <option value="M">Medical</option>
      <option value="N">Non-Medical</option>
      <option value="A">Arts</option>
      <option selected="selected" value="C">Commerce</option>
  ...
  <tr>
    <td colspan="3">
                            <div id="Anthem_ctl00_ContentPlaceHolder1_panelMedicalBoard__"></div>
                        </td>
  </tr>
  <tr>
    <td colspan="3">
                            <div id="Anthem_ctl00_ContentPlaceHolder1_pnlMedicalService__"></div>
                        </td>
  </tr>
  <tr>
    <td colspan="3">
                            <div id="Anthem_ctl00_ContentPlaceHolder1_panelIntership__"></div>
                        </td>
  </tr>
  ...
  <tr>
    <td colspan="3">
                            <div id="Anthem_ctl00_ContentPlaceHolder1_pnl_WeakerSectionIncome__"></div>
                        </td>
  </tr>
  <tr id="ctl00_ContentPlaceHolder1_trPhysicallChall">
    ...
    <td>
      ...
      <tbody><tr>
        <td><span><input id="ctl00_ContentPlaceHolder1_rdbphysicallychallenged_0" type="radio" name="ctl00$ContentPlaceHolder1$rdbphysicallychallenged" value="Y" onclick="javascript:Anthem_FireCallBackEvent(this,event,'ctl00$ContentPlaceHolder1$rdbphysicallychallenged','0',false,'','','',true,null,null,null,true,true);"><label for="ctl00_ContentPlaceHolder1_rdbphysicallychallenged_0">Yes</label></span></td><td><span><input id="ctl00_ContentPlaceHolder1_rdbphysicallychallenged_1" type="radio" name="ctl00$ContentPlaceHolder1$rdbphysicallychallenged" value="N" checked="checked"><label for="ctl00_ContentPlaceHolder1_rdbphysicallychallenged_1">No</label></span></td>
      </tr>
    </tbody></table></div>
  ...
  <tr>
    ...
    <td class="colon">:</td>
    <td>
                            <span id="Anthem_ctl00_ContentPlaceHolder1_ddlCategory__"><select name="ctl00$ContentPlaceHolder1$ddlCategory" id="ctl00_ContentPlaceHolder1_ddlCategory" disabled="disabled" class="dropdownlong" onchange="CategoryOnchange(this);javascript:Anthem_FireCallBackEvent(this,event,'ctl00$ContentPlaceHolder1$ddlCategory','',false,'','','',true,null,null,null,true,true);return false;">
      <option value="0">-- Select Category --</option>
      <option value="118">General-EWS</option>
      <option value="45">General-Ex Servicemen/Wives/Ward Of Ex-Servicemen/Wives/Widows/Wards of Defence Personnel</option>
      <option selected="selected" value="56">General-Open</option>
      <option value="48">General-Person with Disability (PwD)</option>
      <option value="46">General-Ward Of Freedom Fighter</option>
      <option value="114">OBC- Person with Disability (PwD)</option>
      <option value="49">OBC-Ex Servicemen/Wives/Ward Of Ex-Servicemen/Wives/Widows/Wards of Defence Personnel</option>
      <option value="50">OBC-IRDP</option>
      <option value="31">OBC-Open</option>
      <option value="51">SC-Ex Servicemen/Wives/Ward Of Ex-Servicemen/Wives/Widows/Wards of Defence Personnel</option>
      <option value="53">SC-IRDP</option>
      <option value="58">SC-Open</option>
      <option value="54">SC-Person with Disability (PwD)</option>
      <option value="52">SC-Ward Of Freedom Fighter</option>
      <option value="115">ST-Ex Servicemen/Wives/Ward Of Ex-Servicemen/Wives/Widows/Wards of Defence Personnel</option>
      <option value="55">ST-IRDP</option>
      <option value="57">ST-Open</option>
  ...
  <tr id="ctl00_ContentPlaceHolder1_tr_UR_Economical_Weaker_Section">
    <td colspan="3">
                            <div id="Anthem_ctl00_ContentPlaceHolder1_pnl_UR_Economical_Weaker_Section__"></div>
                        </td>
  </tr>
  <tr id="ctl00_ContentPlaceHolder1_trSubCategory">
    <td colspan="3">
                            <div id="Anthem_ctl00_ContentPlaceHolder1_panelSubCategoryr__"></div>
                        </td>
  </tr>
  <tr id="ctl00_ContentPlaceHolder1_trSub1Category">
    <td colspan="3">
                            <div id="Anthem_ctl00_ContentPlaceHolder1_panelSub1Category__"></div>
                        </td>
  </tr>
  <tr>
    ...
    <td>Amount Rs.
                            ...
                            <span id="Anthem_ctl00_ContentPlaceHolder1_stroRs__"><span id="ctl00_ContentPlaceHolder1_stroRs" style="font-weight: bold">1100.00</span></span>
                            

                        </td>
  </tr>
  <tr>
    <td class="vtext">What is 
                            <br>
                            <strong>क्या है</strong></td>
    <td class="colon">?</td>
    <td>
                            
                            <span id="Anthem_ctl00_ContentPlaceHolder1_strFirsNo__"><span id="ctl00_ContentPlaceHolder1_strFirsNo" style="font-weight: bold">40</span></span>
                            +
                            <span id="Anthem_ctl00_ContentPlaceHolder1_strSecondNo__"><span id="ctl00_ContentPlaceHolder1_strSecondNo" style="font-weight: bold">7</span></span>
                            <span id="Anthem_ctl00_ContentPlaceHolder1_txtCaptcha__"><input name="ctl00$ContentPlaceHolder1$txtCaptcha" type="text" maxlength="3" id="ctl00_ContentPlaceHolder1_txtCaptcha" class="textbox2" ondrop="return false;" onkeypress="return isNumber(event)"></span><span style="color: red">*</span>
  ...
  <tr>
    <td colspan="3" align="center"><strong><span style="color: #009e0c">For Graduation Document, Kindly update your CMC or all combined DMC/Grade cards merged PDF file properly for the preparation of merit.</span></strong></td>
  </tr>
  <tr>
...
//]]>
  ...
  <table class="table" cellspacing="1" cellpadding="1" rules="all" border="1" id="ctl00_ContentPlaceHolder1_gvsubject" style="width:100%;border:1px solid #B0B0B0;border-collapse:collapse; margin:15px 0;">
    <tbody><tr class="header-style">
      ...
      <td align="center" style="width:5%;">
                                    ...
                                    <span id="Anthem_ctl00_ContentPlaceHolder1_gvsubject_ctl02_lblExamPassed__"><span id="ctl00_ContentPlaceHolder1_gvsubject_ctl02_lblExamPassed">+2 or its Equivalent</span></span>
                                    ...
                                    <span id="Anthem_ctl00_ContentPlaceHolder1_gvsubject_ctl02_txtNameofUniver__"><input name="ctl00$ContentPlaceHolder1$gvsubject$ctl02$txtNameofUniver" type="text" value="CENTRAL BOARD OF SECONDARY EDUCATION" maxlength="50" id="ctl00_ContentPlaceHolder1_gvsubject_ctl02_txtNameofUniver" class="textbox" onpaste="return false" ondrop="return false"></span>
        ...
        <option value="2023">2023</option>
                                    ...
                                    <span id="Anthem_ctl00_ContentPlaceHolder1_gvsubject_ctl02_txtExamRollNo__"><input name="ctl00$ContentPlaceHolder1$gvsubject$ctl02$txtExamRollNo" type="text" value="17707513" maxlength="15" id="ctl00_ContentPlaceHolder1_gvsubject_ctl02_txtExamRollNo" class="textbox" onpaste="return false" ondrop="return false"></span>
                                </td>
                            ...
                            <table>
                                <tbody><tr>
                                    <td>
                                        ...
                                        <span id="Anthem_ctl00_ContentPlaceHolder1_ImgProfilePic__"><img id="ctl00_ContentPlaceHolder1_ImgProfilePic" src="https://image.hpushimla.in/HPU_DOC//PreAdmission/PG/PreAdmission_PG_PP_597231995_1c79154a-d6db-4383-a616-00b654bf88c8_423197_20230514142953543PP_186703828_4702972.jpg" style="height:100px;width:100px;border-width:0px;"></span><span style="color: red">*</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tbody><tr>
                                    <td>
                                        ...
                                        <div id="Anthem_ctl00_ContentPlaceHolder1_Panel3__"><div id="ctl00_ContentPlaceHolder1_Panel3">
                                            ...
                                            <span id="Anthem_ctl00_ContentPlaceHolder1_ImgSignature__"><img id="ctl00_ContentPlaceHolder1_ImgSignature" src="https://image.hpushimla.in/HPU_DOC//PreAdmission/PG/PreAdmission_PG_SS_597231995_dabe3321-7df7-4485-af14-4fc3a2dc8df6_506042_20230514142953612SS_420608079_4187756.jpg" style="height:50px;width:200px;border-width:0px;"></span><span style="color: red">*</span>
  ...
  <tr>
    <td colspan="3">
                            <div id="Anthem_ctl00_ContentPlaceHolder1_pnl_PGAdditional_Documents__"></div>
...
Sys.WebForms.PageRequestManager._initialize('ctl00$ContentPlaceHolder1$ScriptManagerProxy1', 'aspnetForm', [], [], [], 90, 'ctl00');
  ...
  <tr>
    ...
    <td>
                            <div style="width: 350px; word-wrap: break-word;">
                                <span id="Anthem_ctl00_ContentPlaceHolder1_lblCAddress__"><span id="ctl00_ContentPlaceHolder1_lblCAddress">VILLAGE PATAHRA POST BAZAHARA TEH SAINJ DISTT KULLU (HP) 175134</span></span>
                            </div>
                        </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
                            <div style="width: 350px; word-wrap: break-word;">
                                <span id="Anthem_ctl00_ContentPlaceHolder1_lblPAddress__"><span id="ctl00_ContentPlaceHolder1_lblPAddress">VILLAGE PATAHRA POST BAZAHARA TEH SAINJ DISTT KULLU (HP) 175134</span></span>
                            </div>
                        </td>
  </tr>
  <tr>
  ...
  <tr id="ctl00_ContentPlaceHolder1_trhpumarkseetno">
    ...
    <td class="colon">:</td>
    <td>
                            <span id="Anthem_ctl00_ContentPlaceHolder1_lblhighschoolmarksheetno__"><span id="ctl00_ContentPlaceHolder1_lblhighschoolmarksheetno">1302143</span></span></td>
  </tr>
  <tr>
    <td class="vtext">Nationality<br>
                            <strong>राष्ट्रीयता</strong></td>
  ...
  <tr id="ctl00_ContentPlaceHolder1_trBonafide">
    <td class="vtext"><span id="ctl00_ContentPlaceHolder1_spnBonafideE">Are you a Bonafide Resident of Himachal Pradesh ?</span>
                            <br>
                            <strong><span id="ctl00_ContentPlaceHolder1_spnBonafideH">आप हिमाचल प्रदेश के वास्तविक निवासी हैं</span></strong></td>
    <td class="colon">:</td>
    <td>
                            <span id="Anthem_ctl00_ContentPlaceHolder1_lblBonafide__"><span id="ctl00_ContentPlaceHolder1_lblBonafide">Yes</span></span>
                        </td>
  </tr>
  <tr id="ctl00_ContentPlaceHolder1_trChildofHPBonafideNO">
    <td colspan="3">
  ...
  <tr id="ctl00_ContentPlaceHolder1_trbonafied_mbbsbd">
    <td colspan="3">
                            <div id="Anthem_ctl00_ContentPlaceHolder1_pnlbonafied_mbbsbd__"></div>
                        </td>
  </tr>
  ...
  <tr id="ctl00_ContentPlaceHolder1_trsinglegirlchil">
    ...
    <td class="colon">:</td>
    <td>
                            <span id="Anthem_ctl00_ContentPlaceHolder1_lblsinglegirlchild__"><span id="ctl00_ContentPlaceHolder1_lblsinglegirlchild">No</span></span></td>
  </tr>
  ...
  <tr id="ctl00_ContentPlaceHolder1_trJammuKashmir">
    <td class="vtext">Do you belongs to J&amp;K State?
                            <br>
                            <strong>क्या आप जम्मू और कश्मीर राज्य से हैं?</strong></td>
    <td class="colon">:</td>
    <td>
                            <span id="Anthem_ctl00_ContentPlaceHolder1_lbljammuKashmir__"><span id="ctl00_ContentPlaceHolder1_lbljammuKashmir">No</span></span></td>
  </tr>
  <tr id="ctl00_ContentPlaceHolder1_trStream">
  ...
  <table class="table" cellspacing="1" cellpadding="1" rules="all" border="1" id="ctl00_ContentPlaceHolder1_gvsubject" style="width:100%;border:1px solid #B0B0B0;border-collapse:collapse; margin:15px 0;">
    <tbody><tr class="header-style">
      ...
      <td align="center" style="width:10%;">
                                    ...
                                    <span id="Anthem_ctl00_ContentPlaceHolder1_gvsubject_ctl02_lblExmPassed__"><span id="ctl00_ContentPlaceHolder1_gvsubject_ctl02_lblExmPassed">+2 or its Equivalent</span></span>
                                    <br>
                                    ...
                                    <span id="Anthem_ctl00_ContentPlaceHolder1_gvsubject_ctl02_lblUniversityName__"><span id="ctl00_ContentPlaceHolder1_gvsubject_ctl02_lblUniversityName">CENTRAL BOARD OF SECONDARY EDUCATION</span></span>
      ...
      <td align="center" style="width:10%;">
                                    ...
                                    <span id="Anthem_ctl00_ContentPlaceHolder1_gvsubject_ctl03_lblExmPassed__"><span id="ctl00_ContentPlaceHolder1_gvsubject_ctl03_lblExmPassed">BA./B.Sc./B.Com or its Equivalent</span></span>
                                    <br>
      ...
      <td align="center" style="width:10%;">
                                    ...
                                    <span id="Anthem_ctl00_ContentPlaceHolder1_gvsubject_ctl04_lblRStatus__"><span id="ctl00_ContentPlaceHolder1_gvsubject_ctl04_lblRStatus"><b>Not Applicable</b></span></span>

                                </td><td align="center" style="width:20%;">
                                    <span id="Anthem_ctl00_ContentPlaceHolder1_gvsubject_ctl04_lblExmPassed__"><span id="ctl00_ContentPlaceHolder1_gvsubject_ctl04_lblExmPassed">M.A./M.Sc./M.Com or its Equivalent</span></span>
                                    <br>
                                ...
                                <tbody><tr>
                                    <td>
                                        ...
                                        <div id="Anthem_ctl00_ContentPlaceHolder1_pnl2__"><div id="ctl00_ContentPlaceHolder1_pnl2">
                                            ...
                                            <span id="Anthem_ctl00_ContentPlaceHolder1_ImgProfilePic__"><img id="ctl00_ContentPlaceHolder1_ImgProfilePic" src="https://image.hpushimla.in/HPU_DOC//PreAdmission/PG/PreAdmission_PG_PP_597231995_1c79154a-d6db-4383-a616-00b654bf88c8_423197_20230514142953543PP_186703828_4702972.jpg" style="height:100px;width:100px;border-width:0px;"></span>
                                ...
                                <tbody><tr>
                                    <td>
                                        ...
                                        <div id="Anthem_ctl00_ContentPlaceHolder1_Panel3__"><div id="ctl00_ContentPlaceHolder1_Panel3">
                                            ...
                                            <span id="Anthem_ctl00_ContentPlaceHolder1_ImgSignature__"><img id="ctl00_ContentPlaceHolder1_ImgSignature" src="https://image.hpushimla.in/HPU_DOC//PreAdmission/PG/PreAdmission_PG_SS_597231995_dabe3321-7df7-4485-af14-4fc3a2dc8df6_506042_20230514142953612SS_420608079_4187756.jpg" style="height:50px;width:200px;border-width:0px;"></span>
